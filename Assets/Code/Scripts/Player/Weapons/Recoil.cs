...
public class Recoil : MonoBehaviour {
    ...
    [Space (10)]
    public Vector3 RecoilRotationStimulation;
    public Vector3 RecoilKickBackStimulation;
    [Space (10)]
    ...
    {
        CurrentRecoil1 += new Vector3(RecoilRotationStimulation.x, Random.Range(-RecoilRotationStimulation.y, RecoilRotationStimulation.y), Random.Range(-RecoilRotationStimulation.z, RecoilRotationStimulation.z));
        CurrentRecoil3 += new Vector3(Random.Range(-RecoilKickBackStimulation.x, RecoilKickBackStimulation.x), Random.Range(-RecoilKickBackStimulation.y, RecoilKickBackStimulation.y), RecoilKickBackStimulation.z);
    }
}