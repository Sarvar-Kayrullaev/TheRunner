    ...
    //                  return col;
                        ...
                        sum += GRABPIXEL(0.00*_Bloom, -6.5);
                        sum += GRABPIXEL(0.01*_Bloom, -6.0);
                        sum += GRABPIXEL(0.02*_Bloom, -5.5);
                        sum += GRABPIXEL(0.03*_Bloom, -5.0);
                        sum += GRABPIXEL(0.04*_Bloom, -4.5);
                        sum += GRABPIXEL(0.05*_Bloom, -4.0);
                        sum += GRABPIXEL(0.07*_Bloom, -3.5);
                        sum += GRABPIXEL(0.09*_Bloom, -3.0);
                        sum += GRABPIXEL(0.105*_Bloom, -2.5);
                        sum += GRABPIXEL(0.12*_Bloom, -2.0);
                        sum += GRABPIXEL(0.135*_Bloom, -1.5);
                        sum += GRABPIXEL(0.15*_Bloom, -1.0);
                        sum += GRABPIXEL(0.175*_Bloom,  -0.5);
